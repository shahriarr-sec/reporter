...
function install_kali() {
		...
		sudo apt-get update;
	 	sudo apt-get install git wget curl nmap masscan sublist3r chromium openssl libnet-ssleay-perl p7zip-full build-essential python-pip python3-pip unzip -y;
		install_pip;
		install_dnscan;
	        install_massdns;
		install_sublist3r;
